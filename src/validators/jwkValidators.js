...
export const jwkValidators = {
  ...
  createJwk: Joi.object({
    kty: Joi.string()
      .valid(...Object.values(KEY_TYPES))
      .required(),
    alg: Joi.string()
      .valid(...Object.values(KEY_ALGORITHMS))
      .required(),
    use: Joi.string()
      .valid(...Object.values(KEY_USAGE))
      .optional(),
    key_ops: Joi.array()
      .items(Joi.string().valid(...Object.values(KEY_OPERATIONS)))
      .optional(),
...
// ✅ Export constants
export { KEY_TYPES, KEY_ALGORITHMS, KEY_OPERATIONS, KEY_USAGE };
